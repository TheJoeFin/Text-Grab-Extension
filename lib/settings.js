...
export const DEFAULT_SETTINGS = {
  ...
  regionMode: 'text',          // last used select-region mode; defaults to direct text grab (the extension's distinctive feature) rather than the screenshot/Text Grab handoff
