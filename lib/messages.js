...
// Table/list copy output formats (user-selectable via the tableFormat setting).
export const FORMAT = {
  SPREADSHEET: 'spreadsheet', // "Returns & Tab": text/html table + text/plain TSV
  MARKDOWN: 'markdown',       // text/plain Markdown table only
  HTML: 'html',              // text/html table + text/plain raw <table> markup
};
